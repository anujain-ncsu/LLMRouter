...
_DEFAULT_MODELS: list[ModelInfo] = [
    ModelInfo(
        ...
        endpoint_url="http://localhost:8100/models/novamind-7b/generate",
    ...
    ModelInfo(
        ...
        endpoint_url="http://localhost:8100/models/quantumleap-13b/generate",
    ...
    ModelInfo(
        ...
        endpoint_url="http://localhost:8100/models/stellarcode-70b/generate",
    ...
    ModelInfo(
        ...
        endpoint_url="http://localhost:8100/models/nebulachat-3b/generate",
